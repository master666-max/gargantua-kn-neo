...
> **中文首页 / Chinese front page: [README.md](README.md)** -- and the Chinese results report is
> [docs/成果报告.md](docs/成果报告.md).  This file is the full engineering record (every falsified
> hypothesis, round by round); it is kept in English on purpose, and the Chinese page links back here.
